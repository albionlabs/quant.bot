---
name: "Orderbook"
description: "Deploy Raindex orderbook strategies via MCP-backed tooling. Use when the user asks to list, inspect, compose, deploy, buy, or sell using a Raindex strategy, or asks about available trading strategies."
---
...
For oil-backed reserve token strategies (`oil-token-fair-value-limit` and `oil-token-fair-value-dca`), see [references/oil-strategies.md](references/oil-strategies.md) for field definitions, auto-fetching instructions, and multi-strategy deployment guidance.
